    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 w-9/12 mx-auto p-9 bg-gradient-to-r from-orange-700 to-red-700 mb-4">
                ...
                <img className="mb-7" src="https://i.ibb.co.com/rGbyHNS/images-5.jpg"></img>
                <img src="https://i.ibb.co.com/whRvM1B/images-6.jpg"></img>
                <img src="https://i.ibb.co.com/mzmKh4T/images-7.jpg"></img>
