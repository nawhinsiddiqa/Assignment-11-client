    ...
    return (
        <div>
           ...
           Combo' is a word which is used instead of combination. So when an offer comes in combination with some other thing it is called a combo offer. Previously, some Telecom players sold phone calls with mobile data in combo offers. Many eateries sold sandwich or other snacks with cold drinks in combo offer. 
                      ...
                      <img className="w-[400px] mx-auto" src="https://i.ibb.co.com/bP495s1/th-1.jpg"></img>
                      
                            </div>

                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                                <img  className ="w-[400px] h-64 my-4"src="https://i.ibb.co.com/C1hFtXS/Food-Combo-Offers.jpg"></img>
                                <img  className ="w-[600px] h-64 my-4 mr-4"src="https://i.ibb.co.com/VNyRTrb/chicken-rice-combo-set-8-01-1520-1024x350.png"></img>
                                <img  className ="w-[400px] my-4 "src="https://i.ibb.co.com/cy32PmH/Beef-Burritos-Rice-Beans.webp"></img>
                            </div>
